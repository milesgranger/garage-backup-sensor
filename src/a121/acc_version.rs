...
extern "C" {
    #[doc = " @brief Get the version of the Acconeer software\n\n @return A string describing the software version."]
    pub fn acc_version_get() -> *const cty::c_char;
}
extern "C" {
    #[doc = " @brief Get the version of the Acconeer software as a hex number\n\n @return An uint32 number, 0xMMMMmmPP where M is major, m is minor and P is patch"]
    pub fn acc_version_get_hex() -> u32;
}
